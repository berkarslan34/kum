#bu altyapi @botaltyapilari kanalina aitdir cr verip paylaşabilirsiniz 
...
API_TOKEN = '6416149862:AAFBzd1wqv9qS0iYrQKhCDq1ySvcVupnyP8'

bot = telebot.TeleBot(API_TOKEN) #Webhook'u sil
bot.delete_webhook() # Yoklama başlat bot.polling() ``` 2 *
...
def start(message):
    ...
    button1 = types.InlineKeyboardButton("Sahibim ❤️‍🩹", url="https://t.me/benberkdemir")
    button2 = types.InlineKeyboardButton("Kanal 😍", url="https://t.me/botaltyapilari")
    button3 = types.InlineKeyboardButton("Beni Gruba Ekle💫", url="https://t.me/trkumar_bot_bot?startgroup=new ")
